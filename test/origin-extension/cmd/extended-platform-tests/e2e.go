...
import (
	...
	"github.com/openshift/operator-framework-operator-controller/test/origin-extension/pkg/test/ginkgo"
	_ "github.com/openshift/operator-framework-operator-controller/test/origin-extension/test/extended"
)
